...
if gamepadID
{
    leftX = joystick_xpos(1)// left joystick x
    leftY = joystick_ypos(1)// left joystick y
    
    rightX = joystick_upos(1)// right stick y
    rightY = joystick_rpos(1)// right stick x
}
else
{
    leftX = 0
...
for(i = 0; i < 10; i += 1)
{
    if joystick_check_button(gamepadID, i)
    {
        show_message(i)
    }
}
